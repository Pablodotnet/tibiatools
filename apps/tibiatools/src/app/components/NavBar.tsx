...
export default function Navbar() {
  return (
    <nav className="w-full border-b dark:border-neutral-700 bg-white dark:bg-neutral-900">
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
        ...
        <NavigationMenu.Root>
          <NavigationMenu.List className="flex gap-6 items-center">
            <NavigationMenu.Item>
              <NavigationMenu.Trigger className="flex items-center gap-1 font-medium text-neutral-800 dark:text-neutral-200 focus:outline-none">
                Features <ChevronDown className="w-4 h-4" />
              </NavigationMenu.Trigger>
              <NavigationMenu.Content className="absolute mt-2 rounded-xl shadow-lg p-4 bg-neutral-50 dark:bg-neutral-800">
                <ul className="flex flex-col gap-2 w-48">
                  <li className="hover:bg-gray-100 dark:hover:bg-neutral-800 p-2 rounded-lg cursor-pointer">
                    Feature A
                  </li>
                  <li className="hover:bg-gray-100 dark:hover:bg-neutral-800 p-2 rounded-lg cursor-pointer">
                    Feature B
            ...
            <NavigationMenu.Item>
              <NavigationMenu.Link
                className="font-medium text-neutral-800 dark:text-neutral-200"
                href="https://github.com/pablodotnet/tibiatools"
                target="__blank"
              >
                <svg
                  className="w-4 h-4 fill-current text-neutral-800 dark:text-neutral-200"
                  role="img"
                  viewBox="0 0 24 24"
