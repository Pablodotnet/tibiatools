...
type PandaIconProps = React.SVGProps<SVGSVGElement>;

export function PandaIcon(props: PandaIconProps) {
  const { theme } = useTheme(); // Get the current theme (light or dark)

  // Set the color of the panda based on the theme
  const pandaColor = theme === "dark" ? "#ffffff" : "#000000";
  ...
  return (
    ...
    >
      <svg
        ...
        xmlSpace="preserve"
      >
        <style type="text/css">{`.st0{fill:${pandaColor};}`}</style>
        <g>
          <path
            className="st0"
            d="M210.574,298.095c13.291-39.886-1.344-62.965-22.773-66.983c-25.862-4.847-44.194,4.018-72.33,40.184
            c-28.129,36.166-18.747,91.078,29.473,92.423C185.127,364.829,201.2,326.216,210.574,298.095z"
          />
          <path
            className="st0"
            d="M318.735,229.596c-25.447,10.71-30.701,28.426-17.41,68.304c9.374,28.129,25.439,66.749,65.631,65.632
            c48.221-1.329,57.594-56.242,29.466-92.423C368.292,234.951,344.19,218.885,318.735,229.596z"
          />
          <path
            className="st0"
            d="M145.28,140.472c0.344-2.877,0.532-5.801,0.532-8.756c0-40.277-32.632-72.917-72.901-72.917
          ...
          <path
            className="st0"
            d="M439.091,61.613c-40.262,0-72.91,32.632-72.91,72.902c0,2.978,0.203,5.902,0.548,8.772
          ...
          <path
            className="st0"
            d="M322.581,420.461c-3.807-1.532-8.131,0.328-9.655,4.128c-0.978,2.455-2.283,4.449-3.847,6.137
